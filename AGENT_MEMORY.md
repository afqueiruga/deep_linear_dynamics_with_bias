...
- `RESEARCH_SYNTHESIS_LOG.md` is the consolidated snapshot of current hypotheses, empirical/theory conclusions, and recommended next steps; use it as the first reference for project status, then consult `LOG.md`/`THEORY_LOG.md` for detailed evidence and chronology.
